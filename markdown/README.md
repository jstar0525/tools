...
```
![석촌호수 러버덕](./images/img.jpg)
![석촌호수 러버덕](./images/img.jpg "RubberDuck")

사이즈 조절 기능은 없기 때문에 ```<img width="" height=""></img>```를 이용한다.

예
```
<img src="./images/img.jpg" width="450px" height="300px" title="px(픽셀) 크기 설정" alt="RubberDuck"></img><br/>
<img src="./images/img.jpg" width="40%" height="30%" title="%(비율) 크기 설정" alt="RubberDuck"></img>
```
