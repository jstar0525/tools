...
![Extension Sign In](images/extension-signin.png)
...
![Clone From GitHub](images/clone-from-github.gif)
...
![User and Issue suggestions](images/user-issue-suggest.gif)
...
![Creating a Pull Request](images/pull-request-create.gif)
...
![Review Pull Request](images/review-pull-request.gif)
...
![Changes in Pull Request](images/changes-view.png)
...
![Create Issue from TODO](images/issue-from-todo.gif)
...
![Work on Issue](images/work-on-issue.gif)
