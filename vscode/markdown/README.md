...
![Markdown Preview](images/preview.png)
...
![The preview automatically switching to preview the current Markdown document](images/md-dynamic-preview.gif)
...
![A locked markdown preview](images/locked-preview-title.png)
...
![Markdown Preview editor selection scroll sync](images/preview-scroll-sync.gif)
...
![Markdown Preview editor line marker](images/preview-selection-marker.png)
...
![Markdown Preview double click switches to editor](images/double-click-preview-switch.gif)
...
![Markdown Outline view](images/markdown-outline-view.png)
...
![markdown security alert](images/security-alert.png)
...
![markdown security selector](images/security-selector.png)
